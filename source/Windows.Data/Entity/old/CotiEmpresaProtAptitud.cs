...
{
    public partial class CotiEmpresaProtAptitud
    {
        public int IIdCotiEmpProtPruebaAptitud { get; set; }
        ...
        public virtual DefCatalogoAptitud IIdCatalogoAptitudNavigation { get; set; }
